...
export default function Page() {
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-ink-950">
      <div className="pointer-events-none absolute left-1/2 top-[-140px] h-[420px] w-[620px] -translate-x-1/2 rounded-full bg-ember-500/[0.06] blur-[110px]" />
      ...
      <p className="absolute bottom-4 right-5 hidden font-display text-[11px] font-semibold tracking-[0.22em] text-fog-600 lg:block">
        KAIROS · PLAN LIKE IT MATTERS
      </p>
    </div>
  );
}
